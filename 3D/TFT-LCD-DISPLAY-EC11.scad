...
//
//  This is a box for TFT-LCD-DISPLAY-EC11
//
...
pcbThickness        = 6; 
standoffHeight      = 0.0; //-- How much the PCB needs to be raised from the base to leave room for solderings and whatnot
standoffDiameter    = 7;
...
pcbStands = 
[
  //  [3, 3, standoffHeight, -1, standoffDiameter, standoffPinDiameter, standoffHoleSlack, 0, 0, yappBoth, yappPin, yappAllCorners]
];
...
connectors   =
[
    [3, 3, standoffHeight, 3.5, 7, 3.5+0.4, 7+0.4, -1, -1
          , yappBoth, yappHole, yappAllCorners
          , yappCountersink, [yappPCBName, "Main"]
          , yappThroughLid]
];
...
cutoutsBase = 
[
 // [10, 10, 30, 60, 3, yappRoundedRect]
];

cutoutsLid  = 
[
 // [(pcbLength/2)-7, (pcbWidth/2), 2, 2, 1, yappRoundedRect, yappCenter]
  [(pcbLength/2)-3, (pcbWidth/2), 52, 40, 1, yappRoundedRect, yappCenter]
 ,[79, pcbWidth-9, 13, 13, 4, yappCircle, yappCenter]  // Rotary Encoder
 ,[79, pcbWidth-31, 13, 13, 3.5, yappCircle, yappCenter]  // Key0
];
